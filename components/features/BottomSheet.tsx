      ...
      {isOpen && (
        <>
          ...
          >
            ...
            <div className="flex-1 overflow-y-auto px-5" style={{ paddingBottom: "max(24px, env(safe-area-inset-bottom))" }}>
              <p className="mb-4 text-[16px] font-semibold text-[#1A1A1A]">{title}</p>
              {children}
            </div>
          </motion.div>
        </>
